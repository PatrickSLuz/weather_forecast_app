...
abstract class AppLocalizations {
  ...
  /// No description provided for @genericErrorMsg.
  ///
  /// In en, this message translates to:
  /// **'Sorry, there was an unknown error. Please try again later or contact support.'**
  String get genericErrorMsg;

  /// No description provided for @apiBadRequestMsg.
  ///
  /// In en, this message translates to:
  /// **'Your request could not be understood by the server. Please check the data and try again.'**
  String get apiBadRequestMsg;

  /// No description provided for @apiUnauthorizedMsg.
  ///
  /// In en, this message translates to:
  /// **'Sorry, you are not authorized to access this resource. Please check your credentials and try again.'**
  String get apiUnauthorizedMsg;

  /// No description provided for @apiForbiddenMsg.
  ///
  /// In en, this message translates to:
  /// **'Access to this resource is denied. You may not have the necessary permissions to view this page. Please contact support.'**
  String get apiForbiddenMsg;

  /// No description provided for @apiNotFoundMsg.
  ///
  /// In en, this message translates to:
  /// **'Oops! The page you are looking for could not be found. Please check the URL and try again.'**
  String get apiNotFoundMsg;

  /// No description provided for @apiInternalServerErrorMsg.
  ///
  /// In en, this message translates to:
  /// **'Sorry, there was an error on our server. Our team has been notified and we are working to resolve the issue. Please try again later.'**
  String get apiInternalServerErrorMsg;

  /// No description provided for @apiServiceUnavailableMsg.
  ///
  /// In en, this message translates to:
  /// **'We\'re currently experiencing high traffic or performing maintenance. Please try again in a few minutes.'**
  String get apiServiceUnavailableMsg;
}
