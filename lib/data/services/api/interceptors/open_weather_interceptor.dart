...
InterceptorsWrapper openWeatherInterceptor() {
...
void _onRequest(RequestOptions options, RequestInterceptorHandler handler) {
  ...
  options.headers['mode'] = 'json';
  options.headers['lang'] = AppI10n.instance.locale.toLowerCase();
  options.headers['appid'] = Env.weatherApiAppId;
