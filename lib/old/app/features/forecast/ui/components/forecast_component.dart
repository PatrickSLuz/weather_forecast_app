...
import 'package:weather_forecast_app/old/app/features/forecast/ui/widgets/weather_forecast_card_widget.dart';
        ...
        return SingleChildScrollView(
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  '${DateFormat.EEEE().format(dateTimeNowByTimezone)}\n${DateFormat.yMd().add_Hm().format(dateTimeNowByTimezone)}',
