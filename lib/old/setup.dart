...
import 'package:weather_forecast_app/old/design_system/assets/preload_svg.dart';
import 'package:weather_forecast_app/old/firebase_options.dart';
...
Future<void> firebaseSetup() async {
  ...
  if (Environment.isProd && !kDebugMode) {
